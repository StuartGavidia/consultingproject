---
title: "Consulting Project Written Report with Elizabeth Larios"
...
## Hand Hygiene Perception Survey
```{r, warning=FALSE}
...
* Ensuring anonymity of Nurses
* Making sure our graphs are not misrepresenting the data
* Being transparent with findings
* Being mindful and aware of possible external factors that could have affected data collection and anaylsis

## Main Challenges
* Sorting the CLABSI data
* Link CLABSI data cases to a specific nurse
* Health Terms
* Generating graphs based on a timeline

## Shiny App that encompasses all graphs
